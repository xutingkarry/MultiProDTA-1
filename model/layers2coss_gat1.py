...
class StructureExtractor(nn.Module):
    ...
    def __init__(self, embed_dim, gnn_type="gcn", num_layers=2,
        ...
        self.concat = concat
        self.gnn1=gnn.GATConv(embed_dim, embed_dim*4)
        self.gnn2 = gnn.GATConv(embed_dim*4, embed_dim*2)
        self.gnn3 = gnn.GATConv(embed_dim*2, embed_dim)
        self.gnn=gnn.GATConv(embed_dim,embed_dim)
