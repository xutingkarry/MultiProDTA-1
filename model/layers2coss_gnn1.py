...
class StructureExtractor(nn.Module):
    ...
    def __init__(self, embed_dim, gnn_type="gcn", num_layers=2,
        ...
        self.concat = concat
        self.gnn1=gnn.GraphConv(embed_dim, embed_dim*4)
        self.gnn2 = gnn.GraphConv(embed_dim*4, embed_dim*2)
        self.gnn3 = gnn.GraphConv(embed_dim*2, embed_dim)
        self.gnn=gnn.GraphConv(embed_dim,embed_dim)
