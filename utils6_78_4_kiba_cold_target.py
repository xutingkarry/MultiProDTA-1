...
class DTADataset_pro(InMemoryDataset):
    ...
    def processed_file_names(self):
        ...
        return self.dataset + '_data_pro_graph_3_kiba_cold_target.pt'
...
class DTADataset(InMemoryDataset):
    ...
    @property
    def processed_file_names(self):
        return self.dataset + '_data_mol_78_1_kiba_cold_target.pt'
...
class DTADataset_pro_3d(InMemoryDataset):
    ...
    @property
    def processed_file_names(self):
        return self.dataset + '_data_pro_3d_3_kiba_cold_target.pt'
