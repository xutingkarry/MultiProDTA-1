...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        # 训练集
        df = pd.read_csv(process_dir + dataset+'/'+dataset + '_cold_drug_train_42.csv')
        ...
        # 验证集
        df = pd.read_csv(process_dir + dataset+'/'+dataset + '_cold_drug_test_42.csv')
