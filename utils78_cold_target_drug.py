...
class DTADataset(InMemoryDataset):
    ...
    @property
    def processed_file_names(self):
        return self.dataset + '_data_cold_target_drug_mol.pt'
...
class DTADataset1(InMemoryDataset):
    ...
    @property
    def processed_file_names(self):
        return self.dataset + '_data_cold_target_drug_pro_graph.pt'
...
class DTADataset_3d(InMemoryDataset):
    ...
    @property
    def processed_file_names(self):
        return self.dataset + '_data_cold_target_drug_pro_3d_3.pt'
