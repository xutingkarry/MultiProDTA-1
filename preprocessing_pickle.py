...
def sequence2graph(target_key, target_sequence, distance_dir):
    ...
    return target_size, node_features,edge_index,edge_attr
...
def create_dataset(dataset):
    ...
    train_csv = process_dir+dataset + '/raw/data_train.csv'
    test_csv = process_dir+dataset + '/raw/data_test.csv'
    ...
    #                          smile_graph=None, target_graph=target_graph)
    #
    ...
    #                         smile_graph=None, target_graph=target_graph)
    train_data = DTADataset1(root='datasets/datasets/datasets', dataset=dataset + '_' + 'train',
                            drug_smiles=train_drugs,
                            target_sequence=train_prots, y=train_Y,
                            smile_graph=None, target_graph=target_graph)

    test_data = DTADataset1(root='datasets/datasets/datasets', dataset=dataset + '_' + 'test', drug_smiles=test_drugs,
                           target_sequence=test_prots, y=test_Y,
                           smile_graph=None, target_graph=target_graph)
