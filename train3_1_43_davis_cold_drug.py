...
from models.graphTran_cnnpro3d_42_davis import GraphTransformer

from utils6_78_4_cold_drug import *
# import ci_cython
...
def main():
    ...
    for dataset in datasets:#数据准备
        ...
        if ((not os.path.isfile(processed_data_file_train_drug)) or (not os.path.isfile(processed_data_file_test_drug))):
            ...
            train_data_pro_3d = DTADataset_pro_3d_11(root='datasets/datasets/datasets', dataset=dataset + '_train')
            test_data_pro_3d = DTADataset_pro_3d_11(root='datasets/datasets/datasets', dataset=dataset + '_test')
